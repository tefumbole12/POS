...
class QuotationController extends Controller
{
    ...
    public function sendWhatsapp(Request $request)
    {
        ...
        $this->wpMessage($lims_customer_data);

        $message = 'Whatsapp messsage sent successfully';

        return redirect()->back()->with('message', $message);
    }

    public function wpMessage($lims_customer_data){
        $instance='instance45679';
        $token='1nqiced0brn7x82z';
        $to=$lims_customer_data->phone_number;

        $path="public/quotation/documents/quotation.pdf";
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_POSTFIELDS => "token=$token&to=$to&document=$img_base64&filename=quotation.pdf",
