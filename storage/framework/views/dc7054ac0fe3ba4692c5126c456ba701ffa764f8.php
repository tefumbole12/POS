              ...
              <div class="main-menu">
                <ul id="side-main-menu" class="side-menu list-unstyled">
                  ...
                  <?php endif; ?>
                        ...
                        ?>
                        <?php if($index_permission_booking_active): ?>
                            <li><a href="#booking" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-exchange"></i><span><?php echo e(trans('file.Booking Module')); ?></span></a>
                                <ul id="booking" class="collapse list-unstyled ">
                                        ...
                                        ?>
                                    <?php if($create_permission_booking_active): ?>
                                    <li id="booking-create-menu"><a href="<?php echo e(route('booking.create')); ?>">Booking Create</a></li>
                                    <?php endif; ?>
                                        <?php
                                        ...
                                        ?>
                                    <?php if($create_permission_booking_active): ?>
                                        <li id="booking-index-menu"><a href="<?php echo e(route('booking.index')); ?>">Booking List</a></li>
                                        <li id="booking-product-menu"><a href="<?php echo e(route('booking.product')); ?>">Booked Products</a></li>
                                    <?php endif; ?>
                                    <?php if($booking_report_active): ?>
                                        <li id="booking-report-menu">
                                            <a href="<?php echo e(url('report/daily_booking/'.date('Y').'/'.date('m'))); ?>">Booking Calender</a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </li>
                  ...
                  <?php endif; ?>
                    ...
                    ?>
                    <?php if($index_permission_active): ?>
                        <li><a href="#assets" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-home"></i><span><?php echo e(trans('file.Fixed Assets')); ?></span><span></a>
                            <ul id="assets" class="collapse list-unstyled ">
                                <?php if($asset_index_active): ?><li id="assets-dashboard-menu"><a href="<?php echo e(route('asset.dashboard')); ?>"><?php echo e(trans('file.Assets Dashboard')); ?></a></li><?php endif; ?>
                                <?php if($region_index_active): ?><li id="region-menu"><a href="<?php echo e(route('region.index')); ?>"><?php echo e(trans('file.Assets Region')); ?></a></li><?php endif; ?>
                                <?php if($station_index_active): ?><li id="station-menu"><a href="<?php echo e(route('station.index')); ?>"><?php echo e(trans('file.Assets Station')); ?></a></li><?php endif; ?>
                                <?php if($donor_index_active): ?><li id="donor-menu"><a href="<?php echo e(route('donor.index')); ?>"><?php echo e(trans('file.Assets Donor')); ?></a></li><?php endif; ?>
                                <?php if($asset_type_index_active): ?><li id="assets-category-menu"><a href="<?php echo e(route('assetCategory.index')); ?>"><?php echo e(trans('file.Assets Type')); ?></a></li><?php endif; ?>
                                <?php if($asset_add_active): ?><li id="assets-add-menu"><a href="<?php echo e(route('asset.create')); ?>"><?php echo e(trans('file.Add Assets')); ?></a></li><?php endif; ?>
                                <?php if($asset_index_active): ?><li id="assets-list-menu"><a href="<?php echo e(route('asset.index')); ?>"><?php echo e(trans('file.Assets List')); ?></a></li><?php endif; ?>
                                <?php if($activity_index_active): ?><li id="assets-activity-menu-repair"><a href="<?php echo e(route('asset.activity.repair')); ?>"> Repair Activity</a></li><?php endif; ?>
                                <?php if($activity_index_active): ?><li id="assets-activity-menu"><a href="<?php echo e(route('asset.activity')); ?>"> Asset Activity</a></li><?php endif; ?>
                                <?php if($asset_expense_index_active): ?><li id="assets-expense-menu"><a href="<?php echo e(route('asset.expense')); ?>"> Asset Expense</a></li><?php endif; ?>
                                <?php if($asset_disppose_active): ?><li id="assets-dispose-menu"><a href="<?php echo e(route('asset.dispose.list')); ?>"> Dispose Assets</a></li><?php endif; ?>
                                <?php if($asset_transfer_active): ?><li id="assets-transfer-menu"><a href="<?php echo e(route('asset.transfer.list')); ?>"> Transfer Assets</a></li><?php endif; ?>
                                <?php if($asset_sale_active): ?><li id="assets-sale-menu"><a href="<?php echo e(route('asset.sale.list')); ?>"> Asset Sales</a></li><?php endif; ?>
                                <?php if($index_permission_report_active): ?><li id="assets-report-menu"><a href="<?php echo e(route('asset.report.dashboard')); ?>"><?php echo e(trans('file.Assets Report')); ?></a></li><?php endif; ?>
                            </ul>
                        </li>
                    <?php endif; ?>
                  ...
                  <li class=""><a href="#account" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-briefcase"></i><span><?php echo e(trans('file.Accounting')); ?></span></a>
                    <ul id="account" class="collapse list-unstyled ">
                      ...
                      <li id="account-list-menu"><a href="<?php echo e(route('accounts.index')); ?>"><?php echo e(trans('file.Account List')); ?></a></li>
                        ...
                        <?php if($JE_active): ?>
                            <li id="JE-menu">
                                <a href="<?php echo e(url('report/JE')); ?>"><?php echo e(trans('file.JE Report')); ?></a>
                            </li>
                        <?php endif; ?>
                  ...
                  <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document-remove"></i><span><?php echo e(trans('file.Reports')); ?></span></a>
                    <ul id="report" class="collapse list-unstyled ">
                      ...
                      <li id="category_active">
                        <a href="<?php echo e(route('report.category')); ?>">Category Report</a>
                      </li>
                      <?php endif; ?>
                      ...
                      <?php endif; ?>
                      <?php if($average_sale_active): ?>
                      <li id="average_sale_active-menu">
                          <a href="<?php echo e(url('report/average_sale')); ?>"><?php echo e(trans('file.AMC Report')); ?></a>
                      </li>
                      <?php endif; ?>
                      <?php if($JE_active): ?>
                      <li id="JE-menu">
                    ...
                    <div class="modal-body">
                      <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        ...
                        ?>
                          ...
                          <div class="col-md-6 form-group">
                              <label><?php echo e(trans('file.Product Category')); ?> *</label>
                              <select name="category_id" class="selectpicker form-control" required data-live-search="true"   title="Select Products Category...">
                                  <?php $__currentLoopData = $lims_products_category_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control selectpicker" name="department_id" data-live-search="true" required>
                            ...
                            <?php $__currentLoopData = $lims_department_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/html/beyonds/resources/views/layout/main.blade.php ENDPATH**/ ?>