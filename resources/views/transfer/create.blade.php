                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="from_warehouse_id" class="selectpicker form-control" data-live-search="true"   id="from-warehouse-id" title="Select warehouse...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="to_warehouse_id" class="selectpicker form-control" data-live-search="true"   title="Select warehouse...">
                                                @foreach($lims_warehouse_list as $warehouse)
                                                <option value="{{$warehouse->id}}">{{$warehouse->name}}</option>
                                                @endforeach
                                            </select>
