    ...
    <section class="forms">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <form action="{{route('asset.report.general')}}" method="post">
                    @csrf
                ...
                <table id="product-report-table" class="table table-hover" style="width: 100%">
                    ...
                    @foreach($data as $key=>$item)
                        @php
                            ...
                            $income = \App\AssetExpense::where('asset_id', $item->asset_id)->whereBetween('asset_expenses.date', [$yesterday, $tomorrow])->where('activity_type', 'General Activity')->where('type', 'activity')->sum('amount');
