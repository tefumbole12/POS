        ...
        buttons: [
            {
                ...
                customize: function(doc) {
                    doc.pageMargins = [100, 50, 50, 100 ];
                    var cols = [];
                    cols[0] = {text: 'Prepared By: ________________________', alignment: 'left', margin:[20] };
                    cols[1] = {text: 'Checked By ____________________', alignment: 'right', margin:[0,0,20] };
                    var objFooter = {};
