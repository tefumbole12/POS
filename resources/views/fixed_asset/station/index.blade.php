...
<section>
    <div class="container-fluid">
        @if(in_array("station-add", $all_permission))
             <a href="{{route('station.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Add Station')}} </a>
        @endif
    </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default">
                                ...
                                <li>
                                        <a href="{{ route('station.edit', $item->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a>
                                    </li>
                                <li class="divider"></li>
                                @endif
                                    @if(in_array("station-delete", $all_permission))

                                    {{ Form::open(['route' => ['station.destroy', $item->id], 'method' => 'DELETE'] ) }}
                                    <li>
