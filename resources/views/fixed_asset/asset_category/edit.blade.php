            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['assetCategory.update', $lims_category_data->id], 'method' => 'put', 'files' => true]) !!}
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{trans('file.name')}} *</strong> </label>
                                    <input type="text" name="name" required class="form-control" value="{{ $lims_category_data->name }}">
                                </div>
                            </div>
                            @php
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_id" class="form-control">
                                        ...
                                        @foreach($parent_category as $cat)
                                            <option value="{{ $cat->id }}" {{ @$lims_parent_data->id == $cat->id ? 'selected' : '' }}> {{ $cat->name }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
